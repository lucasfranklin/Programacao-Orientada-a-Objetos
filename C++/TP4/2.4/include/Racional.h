...
public:
    ...
    void setRacional(int newNumerator, int newDenominator);
    void setRacional(double newRacional);
    void setRacional(std::string newracional);
    ...
    friend std::istream& operator>>(std::istream& input, Racional& flowIn);
    bool operator()(Racional object1, Racional object2);
...
private:
    ...
    void doubleToRacional(int *tempNumerator, int *tempDenominator, double* valueToConvert);
...
inline bool Racional::operator()(Racional object1, Racional object2){
        return (object1.getRacionalDouble() < object2.getRacionalDouble()) ? (true) : (false);
}
}
#endif // RACIONAL_H
