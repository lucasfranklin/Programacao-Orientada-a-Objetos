...
CWindow::CWindow(const CWindow& copyObject)
{
    x = copyObject.x;
    y = copyObject.y;
    cX = copyObject.cX;
...
CWindow CWindow::operator= (const CWindow& attCWindow)
{
...
istream& operator>>(istream& input, CWindow& flowIn)
{
...
ostream& operator<<(ostream& output, const CWindow& flowOut)
{
//CWindow DATA
    cout << "X e Y: " << endl;
...
CWindow::Canvas::Canvas(const Canvas& copyCanvas)
{
...
CWindow::Canvas CWindow::Canvas::operator= (const Canvas& attObject)
{
...
void CWindow::testCanvasCopy()
{
    Canvas testCanvas = *my_canvas;
    copyCanvas(testCanvas);
}

void CWindow::copyCanvas(Canvas copyCanvas)
{
    Color fontColor = copyCanvas.getFontColor();
    Color featherColor = copyCanvas.getFeatherColor();
    Color brushColor = copyCanvas.getBrushColor();

    //CANVAS DATA
    cout << "Cor da Fonte: " << endl;
    cout << fontColor.getRGBstr() << endl;
    cout << "Tipo da Fonte: " << endl;
    cout << copyCanvas.getFontType() << endl;
    cout << "Tamanho da Fonte: " << endl;
    cout << copyCanvas.getFontSize() << endl;
    cout << "Cor da Pena: " << endl;
    cout << copyCanvas.getFeatherColor().getRGBstr() << endl;
    cout << "Cor do Pincel: " << endl;
    cout << brushColor.getRGBstr() << endl;
}
